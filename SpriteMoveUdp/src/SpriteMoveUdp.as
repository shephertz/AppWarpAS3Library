...
package
{
    ...
    public class SpriteMoveUdp extends Sprite
    {
        ...
        private function onMouseClick(e:MouseEvent):void
        {
            if(WarpClient.getInstance().getConnectionState() == ConnectionState.connected){
                ...
                {
                    sendMessage("projectile",e.localX, e.localY);   
        ...
        private function keyPressedDown(event:KeyboardEvent):void {
            ...
            switch (key) {
                case Keyboard.UP :
                    localPlayer.y -= step;
                    sendMessage("player", localPlayer.x, localPlayer.y);
                    break;
                case Keyboard.DOWN :
                    localPlayer.y += step;
                    sendMessage("player", localPlayer.x, localPlayer.y);
